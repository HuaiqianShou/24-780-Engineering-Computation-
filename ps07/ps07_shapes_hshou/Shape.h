...
Shape class maintains the information for a 2D shape and calculates
properties like area and moments of inertia.
*/
#pragma once
...
protected:
		...
		double perimeter;				// perimeter of shape
...
public:
	...
	// returns a collection of strings with all the shape properties
